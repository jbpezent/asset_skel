...
class PardisoLDLT : public PardisoImpl<PardisoLDLT<MatrixType, Options> > {
 ...
 public:
  ...
  inline int neigs() const { return m_neigs; }
  inline int peigs() const { return m_peigs; }
  inline int ppivs() const { return m_ppiv; }
  void release() {
      Base::pardisoRelease();
  ...
  void setMatrix(const MatrixType& mat) { this->m_matrix = mat; }
  ...
  void setParams() {
    ...
    m_iparm[11] = 0;            // Not in use
    m_iparm[12] =
        m_matching;   // Maximum weighted matching algorithm is switched-off
